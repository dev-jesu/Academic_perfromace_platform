...
- **JWT Authentication**: We use JSON Web Tokens (JWT) for secure, stateless authentication between the frontend and backend. Supabase Auth handles the token generation and FastAPI validates it.
